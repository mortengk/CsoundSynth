...
- (id)initWithFrame:(CGRect)frame
{
	if ((self = [super initWithFrame:frame]))
	{
        ...
        self.interactionStyle = MHRotaryKnobInteractionStyleSliderVertical;
        self.scalingFactor = 1.5f;
        self.defaultValue = self.value;
        self.resetsToDefault = YES;
        //self.backgroundImage = [UIImage imageNamed:@"mortensButtonUnder"];
        [self setKnobImage:[UIImage imageNamed:@"moogKnob"] forState:UIControlStateNormal];
        //self.superview.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"blank_image"]];
        ...
        //self.knobImageCenter = CGPointMake([self superview].bounds.size.width/2, [self superview].bounds.size.height/2);
